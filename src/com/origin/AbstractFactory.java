...
class HotDrinkMachine
{
  ...
  public HotDrinkMachine() throws Exception
  {
    ...
    for (AvailableDrink drink : AvailableDrink.values())
    {
      ...
      Class<?> factory = Class.forName("com.origin." + factoryName + "Factory");
  ...
  public IHotDrink makeDrink() throws IOException
  {
    ...
    while (true)
    {
      ...
      if ((s = reader.readLine()) != null
        && (i = java.lang.Integer.parseInt(s)) >= 0
        && i < namedFactories.size())
      {
        System.out.println("Specify amount: ");
        s = reader.readLine();
        if (s != null
          && (amount = java.lang.Integer.parseInt(s)) > 0)
        {
